...
test_expr! {
    ...
    op_add_int_float: "1 + 3.72" => Float(1.0 + 3.72),
    op_add_float_float: "3.1 + 2.71" => Float(3.1 + 2.71),
    op_add_float_int: "3.72 + 1" => Float(1.0 + 3.72),
    op_add_negative: "1 + -3" => Integer(-2),

    op_assert: "+1" => Integer(1),
    op_assert_float: "+3.72" => Float(3.72),
    op_assert_multi: "+++1" => Integer(1),

    op_eq_bool_false_false: "FALSE = FALSE" => Boolean(true),
    op_eq_bool_true_false: "TRUE = FALSE" => Boolean(false),
    op_eq_bool_true_true: "TRUE = TRUE" => Boolean(true),
    ...
    op_negate: "-1" => Integer(-1),
    op_negate_double: "--1" => Integer(1),
    op_negate_float: "-3.72" => Float(-3.72),
    op_negate_mixed: "-+-+-1" => Integer(-1),
    op_negate_multi: "---1" => Integer(-1),

    op_neq_bool_false_false: "FALSE != FALSE" => Boolean(false),
    op_neq_bool_true_false: "TRUE != FALSE" => Boolean(true),
    op_neq_bool_true_true: "TRUE != TRUE" => Boolean(false),
    op_neq_float: "3.14 != 2.718" => Boolean(true),
    op_neq_float_eq: "3.14 != 3.14" => Boolean(false),
    op_neq_float_int: "3.01 != 3" => Boolean(true),
    op_neq_float_int_eq: "3.0 != 3" => Boolean(false),
    op_neq_int: "1 != 2" => Boolean(true),
    op_neq_int_eq: "1 != 1" => Boolean(false),
    op_neq_str: "'abc' != 'xyz'" => Boolean(true),
    op_neq_str_case: "'abc' != 'ABC'" => Boolean(true),
    op_neq_str_eq: "'abc' != 'abc'" => Boolean(false),
}
