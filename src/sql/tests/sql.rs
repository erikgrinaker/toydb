...
test_sql! {
    ...
    insert_float_integer: "INSERT INTO movies (id, title, genre_id, released, rating) VALUES (10, 'max', 1, 2000, 123)",
    insert_float_min: "INSERT INTO movies (id, title, genre_id, released, rating) VALUES (10, 'max', 1, 2000, 1.23456789012345e-307)",
    insert_float_min_neg: "INSERT INTO movies (id, title, genre_id, released, rating) VALUES (10, 'max', 1, 2000, -1.23456789012345e-307)",
    ...
    insert_string_empty: "INSERT INTO movies (id, title, genre_id, released) VALUES (10, '', 1, 2000)",
    insert_string_1024: &format!("INSERT INTO movies (id, title, genre_id, released) VALUES (10, '{}', 1, 2000)", "a".repeat(1024)),
    insert_string_1024_unicode: &format!("INSERT INTO movies (id, title, genre_id, released) VALUES (10, '{}', 1, 2000)", "𐍈".repeat(256)),
    insert_string_1025: &format!("INSERT INTO movies (id, title, genre_id, released) VALUES (10, '{}', 1, 2000)", "a".repeat(1025)),
    insert_string_1025_unicode: &format!("INSERT INTO movies (id, title, genre_id, released) VALUES (10, '{}x', 1, 2000)", "𐍈".repeat(256)),
