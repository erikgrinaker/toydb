...
test_query! {
    ...
    where_pk_or_mixed: "SELECT * FROM movies WHERE (id = 3 OR id = 5) AND genre_id = 1",
    ...
    where_index_or_mixed: "SELECT * FROM movies WHERE (genre_id = 2 OR genre_id = 3) AND studio_id = 2 ORDER BY id",
